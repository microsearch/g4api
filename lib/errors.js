...
function getG4ApiError(error) {
    ...
    const g4error = (_a = error.response) === null || _a === void 0 ? void 0 : _a.headers["x-g4-error"];
    if (typeof g4error !== "undefined")
        return { source: "g4", message: g4error };
    const status = (_b = error.response) === null || _b === void 0 ? void 0 : _b.data.status;
    if (typeof status === "number") {
        switch (status) {
            case 400:
                const statusText = (_c = error.response) === null || _c === void 0 ? void 0 : _c.data.statusText;
